...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange }) => {
  const menuItems = [
    ...
    { id: 'vod', label: 'VOD', icon: Download },
    ...
    <>
      ...
      <div className="hidden md:flex w-64 h-screen bg-chzzk-card border-r border-gray-800 flex-col flex-shrink-0 sticky top-0">
        <div className="p-6 flex items-center space-x-3 border-b border-gray-800">
          ...
          <h1 className="text-xl font-bold text-white tracking-tight">Chzzk<span className="text-chzzk">DL</span></h1>
        </div>
        ...
        <div className="p-4 border-t border-gray-800">
          <div className="bg-gray-900/50 rounded-lg p-3">
            ...
            <p className="text-xs text-gray-600 mt-1">Python 3.14 Engine</p>
          </div>
        </div>
      </div>
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center w-full h-full space-y-1 transition-colors duration-200 ${
                  isActive ? 'text-chzzk' : 'text-gray-500'
                }`}
              >
